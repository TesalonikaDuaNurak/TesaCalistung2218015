...
<body>
  ...
  <div class="sidebar">
   ...
   <section class="home-section">
	...
	<div class="home-content">
		<form action="/updatedata3/{{$paket->id_paket}}" method="post">
            @csrf
  <div class="form-group">
    <label for="exampleInputEmail1">Nama Paket</label>
    <input type="text" name="nama_paket" value="{{$paket->nama_paket}}" class="form-control" id="exampleInputPassword1" placeholder="Nama Paket" value="">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Harga Paket</label>
    <input type="text" name="harga_paket" value="{{$paket->harga_paket}}" class="form-control" id="exampleInputPassword1" placeholder="Harga Paket" value="">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Keterangan Paket</label>
   <textarea name="ket" id="" cols="30" rows="10">{{$paket->ket}}</textarea>
  </div>
