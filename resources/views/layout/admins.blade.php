...
<body>
  ...
  <div class="sidebar">
   ...
   <section class="home-section">
	...
	<div class="home-content">
    <a href="tambahadmin" class="btn btn-sm btn-success">INPUT</a>
  ...
  <tbody>
    ...
    <tr>
				...
				<td>
					<a href="/ubahadmin/{{$d->id}}" class="btn btn-sm btn-warning">EDIT</a>
					<a href="/deleteadmin/{{$d->id}}" class="btn btn-danger">HAPUS</a>
				</td>
</tr>
@endforeach
</tbody>
